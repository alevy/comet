...
public class DHTDBValueFactory {
	 ...
	 * @param _factory
	 */
	public static void init(FactoryInterface _factory) {
		synchronized(lock) {
			if (! was_initialized) {
				factory = _factory;
	...
	public static DHTDBValueImpl create(long _creation_time,
			byte[] _value,
			int	_version,
			...
			boolean _local,
			int	_flags ) {
		return factory.create(_creation_time, _value, _version,
				_originator,
				_sender,
				_local,
				_flags);
	...
	public static DHTDBValueImpl create(DHTTransportContact	_sender,
	...
	public static interface FactoryInterface {
		public DHTDBValueImpl create( long _creation_time,
			byte[] _value,
			int	_version,
			DHTTransportContact _originator,
			DHTTransportContact _sender,
