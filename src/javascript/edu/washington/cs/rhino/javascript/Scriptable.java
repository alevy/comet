...
public interface Scriptable {
     ...
     * @see edu.washington.cs.rhino.javascript.Context#getUndefinedValue
     */
     ...
     * @see edu.washington.cs.rhino.javascript.Scriptable#get(String, Scriptable)
     * @see edu.washington.cs.rhino.javascript.ScriptableObject#getProperty(Scriptable, String)
     */
     ...
     * @see edu.washington.cs.rhino.javascript.ScriptableObject#getProperty(Scriptable, int)
     */
     ...
     * @see edu.washington.cs.rhino.javascript.Scriptable#get(String, Scriptable)
     * @see edu.washington.cs.rhino.javascript.ScriptableObject#putProperty(Scriptable, String, Object)
     * @see edu.washington.cs.rhino.javascript.Context#toObject(Object, Scriptable)
     */
     ...
     * @see edu.washington.cs.rhino.javascript.Scriptable#get(int, Scriptable)
     * @see edu.washington.cs.rhino.javascript.ScriptableObject#putProperty(Scriptable, int, Object)
     * @see edu.washington.cs.rhino.javascript.Context#toObject(Object, Scriptable)
     */
     ...
     * @see edu.washington.cs.rhino.javascript.Scriptable#get(String, Scriptable)
     * @see edu.washington.cs.rhino.javascript.ScriptableObject#deleteProperty(Scriptable, String)
     */
     ...
     * @param index the numeric index for the property
     * @see edu.washington.cs.rhino.javascript.Scriptable#get(int, Scriptable)
     * @see edu.washington.cs.rhino.javascript.ScriptableObject#deleteProperty(Scriptable, int)
     */
