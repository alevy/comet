...
/**
 * Exception thrown by 
 * {@link edu.washington.cs.rhino.javascript.Context#executeScriptWithContinuations(Script, Scriptable)}
 * and {@link edu.washington.cs.rhino.javascript.Context#callFunctionWithContinuations(Callable, Scriptable, Object[])}
 * when execution encounters a continuation captured by
 * {@link edu.washington.cs.rhino.javascript.Context#captureContinuation()}.
 * Exception will contain the captured state needed to restart the continuation
 * with {@link edu.washington.cs.rhino.javascript.Context#resumeContinuation(Object, Scriptable, Object)}.
 * @author Norris Boyd
 */
public class ContinuationPending extends RuntimeException {
     ...
     * calling {@link edu.washington.cs.rhino.javascript.Context#executeScriptWithContinuations(Script, Scriptable)}
     * and {@link edu.washington.cs.rhino.javascript.Context#callFunctionWithContinuations(Callable, Scriptable, Object[])}
     ...
     * {@link edu.washington.cs.rhino.javascript.Context#resumeContinuation(Object, Scriptable, Object)}.
