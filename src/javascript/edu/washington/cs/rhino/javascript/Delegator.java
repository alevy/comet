...
package edu.washington.cs.rhino.javascript;
...
public class Delegator implements Function {
     ...
     *
     * @see edu.washington.cs.rhino.javascript.Delegator#construct
     */
    public Delegator() {
    }
     ...
     * @see edu.washington.cs.rhino.javascript.Scriptable
     */
    ...
    /**
     * @see edu.washington.cs.rhino.javascript.Scriptable#getClassName
     */
    public String getClassName() {
        return obj.getClassName();
    }
    /**
     * @see edu.washington.cs.rhino.javascript.Scriptable#get(String, Scriptable)
     */
    public Object get(String name, Scriptable start) {
        return obj.get(name,start);
    }
    /**
     * @see edu.washington.cs.rhino.javascript.Scriptable#get(int, Scriptable)
     */
    public Object get(int index, Scriptable start) {
        return obj.get(index,start);
        }
    /**
     * @see edu.washington.cs.rhino.javascript.Scriptable#has(String, Scriptable)
     */
    public boolean has(String name, Scriptable start) {
        return obj.has(name,start);
        }
    /**
     * @see edu.washington.cs.rhino.javascript.Scriptable#has(int, Scriptable)
     */
    public boolean has(int index, Scriptable start) {
        return obj.has(index,start);
        }
    /**
     * @see edu.washington.cs.rhino.javascript.Scriptable#put(String, Scriptable, Object)
     */
    public void put(String name, Scriptable start, Object value) {
        obj.put(name,start,value);
    }
    /**
     * @see edu.washington.cs.rhino.javascript.Scriptable#put(int, Scriptable, Object)
     */
    public void put(int index, Scriptable start, Object value) {
        obj.put(index,start,value);
    }
    /**
     * @see edu.washington.cs.rhino.javascript.Scriptable#delete(String)
     */
    public void delete(String name) {
        obj.delete(name);
    }
    /**
     * @see edu.washington.cs.rhino.javascript.Scriptable#delete(int)
     */
    public void delete(int index) {
        obj.delete(index);
    }
    /**
     * @see edu.washington.cs.rhino.javascript.Scriptable#getPrototype
     */
    public Scriptable getPrototype() {
        return obj.getPrototype();
    }
    /**
     * @see edu.washington.cs.rhino.javascript.Scriptable#setPrototype
     */
    public void setPrototype(Scriptable prototype) {
        obj.setPrototype(prototype);
    }
    /**
     * @see edu.washington.cs.rhino.javascript.Scriptable#getParentScope
     */
    public Scriptable getParentScope() {
        return obj.getParentScope();
    }
    /**
     * @see edu.washington.cs.rhino.javascript.Scriptable#setParentScope
     */
    public void setParentScope(Scriptable parent) {
        obj.setParentScope(parent);
    }
    /**
     * @see edu.washington.cs.rhino.javascript.Scriptable#getIds
     */
     ...
     *
     * @see edu.washington.cs.rhino.javascript.Scriptable#getDefaultValue
     */
    ...
    /**
     * @see edu.washington.cs.rhino.javascript.Scriptable#hasInstance
     */
    public boolean hasInstance(Scriptable instance) {
        return obj.hasInstance(instance);
    }
    /**
     * @see edu.washington.cs.rhino.javascript.Function#call
     */
