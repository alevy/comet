...
import edu.washington.cs.rhino.javascript.debug.DebuggableScript;
import edu.washington.cs.rhino.javascript.debug.Debugger;
import edu.washington.cs.rhino.javascript.xml.XMLLib;
...
public class Context
{
    ...
    public static void addContextListener(ContextListener listener)
    {
        ...
        String DBG = "edu.washington.cs.rhino.javascript.tools.debugger.Main";
        if (DBG.equals(listener.getClass().getName())) {
            Class<?> cl = listener.getClass();
            Class<?> factoryClass = Kit.classOrNull(
                "edu.washington.cs.rhino.javascript.ContextFactory");
     ...
     *
     * @see edu.washington.cs.rhino.javascript.ErrorReporter
     */
     ...
     * @see edu.washington.cs.rhino.javascript.SecurityController
     */
            ...
            throws ContinuationPending
    {
        ...
        return Interpreter.restartContinuation(
                (edu.washington.cs.rhino.javascript.NativeContinuation) continuation,
                this, scope, args);
    }
     ...
     * @exception IOException if an IOException was generated by the Reader
     * @see edu.washington.cs.rhino.javascript.Script
     */
    ...
    public final boolean hasClassShutter() {
    	return classShutter != null;
    }
    ...
    private static Class<?> codegenClass = Kit.classOrNull(
                             "edu.washington.cs.rhino.javascript.optimizer.Codegen");
    private static Class<?> interpreterClass = Kit.classOrNull(
                             "edu.washington.cs.rhino.javascript.Interpreter");
    ...
    RegExpProxy getRegExpProxy()
    {
        if (regExpProxy == null) {
            Class<?> cl = Kit.classOrNull(
                          "edu.washington.cs.rhino.javascript.regexp.RegExpImpl");
            if (cl != null) {
