...
import edu.washington.cs.rhino.javascript.debug.DebuggableObject;
                                                  ...
                                                  ConstProperties
{
     ...
     *
     * @see edu.washington.cs.rhino.javascript.ScriptableObject#getAttributes(String)
     * @see edu.washington.cs.rhino.javascript.ScriptableObject#setAttributes(String, int)
     */
     ...
     *
     * @see edu.washington.cs.rhino.javascript.ScriptableObject
     ...
     *
     * @see edu.washington.cs.rhino.javascript.ScriptableObject#getIds()
     * @see edu.washington.cs.rhino.javascript.ScriptableObject#getAttributes(String)
     * @see edu.washington.cs.rhino.javascript.ScriptableObject#setAttributes(String, int)
     */
     ...
     *
     * @see edu.washington.cs.rhino.javascript.ScriptableObject#delete(String)
     * @see edu.washington.cs.rhino.javascript.ScriptableObject#getAttributes(String)
     * @see edu.washington.cs.rhino.javascript.ScriptableObject#setAttributes(String, int)
     */
     ...
     * @see edu.washington.cs.rhino.javascript.ScriptableObject#has(String, Scriptable)
     * @see edu.washington.cs.rhino.javascript.ScriptableObject#READONLY
     * @see edu.washington.cs.rhino.javascript.ScriptableObject#DONTENUM
     * @see edu.washington.cs.rhino.javascript.ScriptableObject#PERMANENT
     * @see edu.washington.cs.rhino.javascript.ScriptableObject#EMPTY
     */
     ...
     * @see edu.washington.cs.rhino.javascript.Function
     * @see edu.washington.cs.rhino.javascript.FunctionObject
     * @see edu.washington.cs.rhino.javascript.ScriptableObject#READONLY
     * @see edu.washington.cs.rhino.javascript.ScriptableObject
